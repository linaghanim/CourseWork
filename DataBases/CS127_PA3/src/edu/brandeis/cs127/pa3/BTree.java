...
/**
 * Class of B+-Trees. All search, insertion and deletion routines are invoked
 * through the B+-Tree object.
 */
public class BTree {
	...
	/**
	 * This produced a graphviz (dot language) output to generate a viewable
	...
	/**
	 * Return leaf node location of where val does or SHOULD appear within this
	 * B+-Tree. Result will indicate which leaf node (result.getNode ()) and which
	 * key index within this leaf node (result.getIndex ()).
	 * 
	 * @param val
	 *            the value to look for in the B tree
	 */
	...
	/**
	 * Insert a integer val in its proper location in the tree. Must make sure to
	 * update the root afterwards if it is replaced.
	 * 
	 * @param val
	 *            the value to insert to the btree
	 */
	public void insert(int val) {
		...
		if (root == null) {
			...
			if (l.getMatch())
				...
				// The tree doesn't contain this key so call insert on the leaf where it should
				// appear
	 ...
	 * 
	 * @param val
	 *            the value to delete from this B tree
	 */
