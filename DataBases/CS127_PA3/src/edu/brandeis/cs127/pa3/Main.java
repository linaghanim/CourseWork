//My code has the issue of pointers in the Delete method. It does not assign parents and children in the right way for all tests since there are many cases and I couldn't find a common way for all. 
